...
class Marca(models.Model):
    ...
    '''abaixo para mostrar no banco de dados o nome da Marca cadastrada'''
    def __str__(self):
        return self.nome
...
class Veiculo(models.Model):
    ...
    def __str__(self):
        return self.marca.nome + ' - ' + self.placa + ' - ' + self.observacoes
...
class MovRotativo(models.Model):
    ...
    valor_hora = valor_hora = models.DecimalField(max_digits=5, decimal_places=2)
    veiculo = models.name = models.ForeignKey(Veiculo, on_delete=models.CASCADE)
